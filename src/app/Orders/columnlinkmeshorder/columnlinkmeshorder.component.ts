...
import { BeamMeshArray, ColumnMeshArray } from 'src/app/Model/StandardbarOrderArray';
...
@Component({
  selector: 'app-columnlinkmeshorder',
  templateUrl: './columnlinkmeshorder.component.html',
  styleUrls: ['./columnlinkmeshorder.component.css']
})
export class ColumnlinkmeshorderComponent {
...
ScheduleProd: any;
  // BBSID: any = 1;
  // @Input() CustomerCode: any='0001102303';
  // @Input() ProjectCode: any='0000113361';
  // @Input() OrderStatus: any="Created";
  // @Input() JobID: any=14;
  // @Input() ScheduledProd: any="YES";
  // @Input() BBSID: any=1;

  showSideTable: boolean = false;
  bbsOrderTable: ColumnMeshArray[] = [];
  bbsOrderTemp: ColumnMeshArray[] = [];
  shapeCodeList: any[] = [];
  sizeList: any[] = [];
  Diameter: any;
  Spacing: any;
  ...
  ngOnInit() {
    //debugger;
    this.StaticImagename = "column_cage.png";
    ...
    if (this.createSharedService.selectedrecord) {
      ...
      //console.log("Columnlinkmesh prcSharedS",this.prcSharedS);
  ...
  ShowShapeList() {
    ...
    modalRef.componentInstance.StructureElement = "COLUMN";
