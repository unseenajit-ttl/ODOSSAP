...
@Component({
  selector: 'app-beamprc',
  templateUrl: './beamprc.component.html',
  styleUrls: ['./beamprc.component.css']
})
export class BeamprcComponent {
  CustomerCode: any;
  ProjectCode: any;
  OrderStatus: any;
  JobID: any;
...
ScheduleProd: any;
  ...
  ngOnInit(): void {  
    ...
    //debugger;
    //console.log("this.prcSharedS",this.prcSharedS);
...
//debugger;
    if(this.ScheduledProd=="Y")
    {
      ...
      .getBeamDetailsNSH_beam_prc(CustomerCode, ProjectCode, PostID, BBSID)
      .subscribe({
        next: (response) => {
