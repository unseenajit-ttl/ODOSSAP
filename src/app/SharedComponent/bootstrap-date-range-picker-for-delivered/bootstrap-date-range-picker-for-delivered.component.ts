import {Component, ViewChild, OnInit, ElementRef, Renderer2, EventEmitter, Output, Input, SimpleChanges, ViewEncapsulation} from '@angular/core';
import {
    NgbDatepicker,
    NgbInputDatepicker,
    NgbDateStruct,
...
const after = (one: NgbDateStruct, two: NgbDateStruct) =>
  !one || !two ? false : one.year === two.year ? one.month === two.month ? one.day === two.day
    ? false : one.day > two.day : one.month > two.month : one.year > two.year;
@Component({
  selector: 'app-bootstrap-date-range-picker-for-delivered',
  templateUrl: './bootstrap-date-range-picker-for-delivered.component.html',
  styleUrls: ['./bootstrap-date-range-picker-for-delivered.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class BootstrapDateRangePickerForDeliveredComponent {
