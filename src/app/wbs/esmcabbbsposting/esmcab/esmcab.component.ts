...
import { ColumnDetailingService } from 'src/app/Detailing/MeshDetailing/ColumnDetailingService';
import { BeamDetailingService } from 'src/app/Detailing/MeshDetailing/BeamDetailingService';
@Component({
  selector: 'app-esmcab',
  templateUrl: './esmcab.component.html',
  styleUrls: ['./esmcab.component.css']
})
export class ESMCabComponent implements OnInit {
  ...
  constructor(
    ...
    this.storedObjectData = localStorage.getItem('ESMBBSCabData');
  ...
  LoadGroupMarkIDPRC(INTGROUPMARKID: any) {
    ...
    console.log(INTGROUPMARKID);
    this.columnDetailingService
      .GetPRCSAPHeaderValuesByGroupMarkId(INTGROUPMARKID)
      .subscribe({
        next: (response) => {
          console.log('SAP Material');
          console.log(response);
